...
public class HordeSummonArgument implements ArgumentType<ResourceLocation> {
   ...
   public static final DynamicCommandExceptionType ERROR_UNKNOWN_HORDE = new DynamicCommandExceptionType((p_93342_) -> {
      return Component.translatable("horde.notFound", p_93342_);
   });
   ...
   public static ResourceLocation getSummonableHorde(CommandContext<CommandSourceStack> p_93339_, String p_93340_) throws CommandSyntaxException {
