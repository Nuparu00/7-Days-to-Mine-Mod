...
public class StoneSpearEntity extends ThrownTrident {
    public StoneSpearEntity(EntityType<? extends ThrownTrident> p_37561_, Level p_37562_) {
        super(p_37561_, p_37562_);
    }
    public StoneSpearEntity(Level p_37569_, LivingEntity p_37570_, ItemStack p_37571_) {
        super(ModEntities.STONE_SPEAR.get(),p_37569_);
