...
public class TwistedZombieModel<T extends TwistedZombieEntity> extends EntityModel<T> implements ArmedModel, HeadedModel {
	...
	public TwistedZombieModel(ModelPart root) {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition leftLeg = partdefinition.addOrReplaceChild("leftLeg", CubeListBuilder.create().texOffs(44, 12).addBox(-2.0F, 0.0F, -2.0F, 4.0F, 12.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offset(2.0F, 12.0F, 0.0F));

		PartDefinition rightLeg = partdefinition.addOrReplaceChild("rightLeg", CubeListBuilder.create().texOffs(16, 40).addBox(-2.0F, 0.0F, -2.0F, 4.0F, 12.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offset(-2.0F, 12.0F, 0.0F));

		PartDefinition rightArm = partdefinition.addOrReplaceChild("rightArm", CubeListBuilder.create().texOffs(0, 32).addBox(-3.0F, -2.0F, -2.0F, 4.0F, 12.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offset(-4.0F, 2.0F, 0.0F));
		...
		PartDefinition leftArm = partdefinition.addOrReplaceChild("leftArm", CubeListBuilder.create().texOffs(32, 0).addBox(-1.0F, -2.0F, -2.0F, 4.0F, 12.0F, 4.0F, new CubeDeformation(0.0F))
				.texOffs(12, 32).addBox(0.0F, -5.0F, 0.0F, 3.0F, 3.0F, 0.0F, new CubeDeformation(0.0F))
				.texOffs(32, 19).addBox(1.5F, -5.0F, -1.5F, 0.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offset(4.0F, 2.0F, 0.0F));
		...
		PartDefinition head = partdefinition.addOrReplaceChild("head", CubeListBuilder.create().texOffs(0, 16).addBox(-4.0F, -8.0F, -4.0F, 8.0F, 8.0F, 8.0F, new CubeDeformation(0.0F))
				...
				.texOffs(0, 0).addBox(-4.0F, -12.0F, 0.0F, 4.0F, 4.0F, 0.0F, new CubeDeformation(0.0F))
				.texOffs(22, 35).addBox(0.0F, -11.0F, -2.0F, 3.0F, 3.0F, 0.0F, new CubeDeformation(0.0F))
				.texOffs(32, 25).addBox(-7.0F, -7.0F, 0.0F, 3.0F, 3.0F, 0.0F, new CubeDeformation(0.0F))
				.texOffs(29, 16).addBox(-7.0F, -5.5F, -1.5F, 3.0F, 0.0F, 3.0F, new CubeDeformation(0.0F))
				.texOffs(12, 29).addBox(1.5F, -11.0F, -3.5F, 0.0F, 3.0F, 3.0F, new CubeDeformation(0.0F))
				.texOffs(0, 0).addBox(-2.0F, -12.0F, -2.0F, 0.0F, 4.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 0.0F, 0.0F));
		...
		PartDefinition body = partdefinition.addOrReplaceChild("body", CubeListBuilder.create().texOffs(28, 28).addBox(-4.0F, 0.0F, -2.0F, 8.0F, 12.0F, 4.0F, new CubeDeformation(0.0F))
				.texOffs(24, 16).addBox(-2.0F, 6.0F, 2.0F, 0.0F, 4.0F, 4.0F, new CubeDeformation(0.0F))
				.texOffs(20, 0).addBox(-4.0F, 8.0F, 2.0F, 4.0F, 0.0F, 4.0F, new CubeDeformation(0.0F))
				.texOffs(0, 12).addBox(0.0F, 3.0F, 2.0F, 0.0F, 4.0F, 4.0F, new CubeDeformation(0.0F))
				.texOffs(20, 16).addBox(-2.0F, 5.0F, 2.0F, 4.0F, 0.0F, 4.0F, new CubeDeformation(0.0F))
				.texOffs(16, 32).addBox(-2.0F, 1.0F, 2.0F, 0.0F, 3.0F, 3.0F, new CubeDeformation(0.0F))
				.texOffs(0, 16).addBox(2.0F, 7.0F, 2.0F, 0.0F, 4.0F, 4.0F, new CubeDeformation(0.0F))
				.texOffs(20, 4).addBox(0.0F, 9.0F, 2.0F, 4.0F, 0.0F, 4.0F, new CubeDeformation(0.0F))
				.texOffs(29, 22).addBox(-3.5F, 2.5F, 2.0F, 3.0F, 0.0F, 3.0F, new CubeDeformation(0.0F))
				.texOffs(29, 19).addBox(1.0F, 6.0F, 2.0F, 3.0F, 0.0F, 3.0F, new CubeDeformation(0.0F))
				.texOffs(18, 29).addBox(2.5F, 4.5F, 2.0F, 0.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 0.0F, 0.0F));
