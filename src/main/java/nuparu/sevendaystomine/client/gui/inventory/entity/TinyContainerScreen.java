...
public class TinyContainerScreen extends AbstractContainerScreen<ContainerTiny> {
	...
	final ContainerTiny container;

	public TinyContainerScreen(ContainerTiny container, Inventory playerInventory, Component title) {
	...
	protected void renderLabels(@NotNull GuiGraphics guiGraphics, int mouseX, int mouseY) {
		...
		guiGraphics.drawString(minecraft.font, this.title, 58, 39, Color.darkGray.getRGB()); /// this.font.draw
