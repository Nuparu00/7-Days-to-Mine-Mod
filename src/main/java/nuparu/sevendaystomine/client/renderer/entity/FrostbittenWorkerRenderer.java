...
public class FrostbittenWorkerRenderer<T extends FrostbittenWorkerEntity, M extends HumanoidModel<T>>
	...
	private static final ResourceLocation ZOMBIE_LOCATION = new ResourceLocation(SevenDaysToMine.MODID,
			"textures/entity/zombie/frostbitten_worker.png");

	public FrostbittenWorkerRenderer(EntityRendererProvider.Context context) {
		super(context, ClientSetup.FROSTBITTEN_WORKER_LAYER);
	}
