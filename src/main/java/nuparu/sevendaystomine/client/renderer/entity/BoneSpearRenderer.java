...
public class BoneSpearRenderer extends EntityRenderer<BoneSpearEntity> {
    ...
    public void render(BoneSpearEntity p_116111_, float p_116112_, float p_116113_, PoseStack p_116114_, MultiBufferSource p_116115_, int p_116116_) {
        p_116114_.pushPose();
    ...
    public ResourceLocation getTextureLocation(BoneSpearEntity p_116109_) {
