...
public class RedEyesLayer<T extends ZombieBaseEntity, M extends EntityModel<T>, A extends EntityModel<T>>
	...
	@Override
	public void render(@NotNull PoseStack p_116983_, @NotNull MultiBufferSource p_116984_, int p_116985_, @NotNull T p_116986_, float p_116987_, float p_116988_, float p_116989_, float p_116990_, float p_116991_, float p_116992_) {
		if (LevelUtils.isBloodmoon(Minecraft.getInstance().level) && p_116986_.isAlive()) {
