            ...
            else
            {
            	if (raytraceresult.typeOfHit == RayTraceResult.Type.BLOCK)
                {
                    ...
                    if (worldIn.getBlockState(blockpos).getMaterial() == Material.WATER)
                    {
                        ...
                        return new ActionResult(EnumActionResult.SUCCESS, this.turnBottleIntoItem(itemstack, playerIn, new ItemStack(com.nuparu.sevendaystomine.init.ModItems.BOTTLED_MURKY_WATER)));
                    }
                }
