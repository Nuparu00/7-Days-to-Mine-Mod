...
public class ChunkGeneratorWasteland extends ChunkGeneratorOverworld {
	...
	public ChunkGeneratorWasteland(World worldIn, long seed, boolean mapFeaturesEnabledIn,
	...
	public void populate(int x, int z) {
		...
		if (biome != ModBiomes.WASTELAND_DESERT && biome != Biomes.DESERT && biome != Biomes.DESERT_HILLS && this.settings.useWaterLakes && !flag
