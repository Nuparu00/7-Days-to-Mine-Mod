...
public class StructureCityPieces {
    ...
    {
        MapGenStructureIO.registerStructureComponent(StructureCityPieces.House1.class, "ViBH");
        MapGenStructureIO.registerStructureComponent(StructureCityPieces.Field1.class, "ViDF");
        MapGenStructureIO.registerStructureComponent(StructureCityPieces.Field2.class, "ViF");
        MapGenStructureIO.registerStructureComponent(StructureCityPieces.Torch.class, "ViL");
        MapGenStructureIO.registerStructureComponent(StructureCityPieces.Hall.class, "ViPH");
        MapGenStructureIO.registerStructureComponent(StructureCityPieces.House4Garden.class, "ViSH");
        MapGenStructureIO.registerStructureComponent(StructureCityPieces.WoodHut.class, "ViSmH");
        MapGenStructureIO.registerStructureComponent(StructureCityPieces.Church.class, "ViST");
        MapGenStructureIO.registerStructureComponent(StructureCityPieces.House2.class, "ViS");
        MapGenStructureIO.registerStructureComponent(StructureCityPieces.Start.class, "ViStart");
        MapGenStructureIO.registerStructureComponent(StructureCityPieces.Path.class, "ViSR");
        MapGenStructureIO.registerStructureComponent(StructureCityPieces.House3.class, "ViTRH");
        MapGenStructureIO.registerStructureComponent(StructureCityPieces.Well.class, "ViW");
    }

    public static List<StructureCityPieces.PieceWeight> getStructureVillageWeightedPieceList(Random random, int size)
    {
        List<StructureCityPieces.PieceWeight> list = Lists.<StructureCityPieces.PieceWeight>newArrayList();
        list.add(new StructureCityPieces.PieceWeight(StructureCityPieces.House4Garden.class, 4, MathHelper.getInt(random, 2 + size, 4 + size * 2)));
        list.add(new StructureCityPieces.PieceWeight(StructureCityPieces.Church.class, 20, MathHelper.getInt(random, 0 + size, 1 + size)));
        list.add(new StructureCityPieces.PieceWeight(StructureCityPieces.House1.class, 20, MathHelper.getInt(random, 0 + size, 2 + size)));
        list.add(new StructureCityPieces.PieceWeight(StructureCityPieces.WoodHut.class, 3, MathHelper.getInt(random, 2 + size, 5 + size * 3)));
        list.add(new StructureCityPieces.PieceWeight(StructureCityPieces.Hall.class, 15, MathHelper.getInt(random, 0 + size, 2 + size)));
        list.add(new StructureCityPieces.PieceWeight(StructureCityPieces.Field1.class, 3, MathHelper.getInt(random, 1 + size, 4 + size)));
        list.add(new StructureCityPieces.PieceWeight(StructureCityPieces.Field2.class, 3, MathHelper.getInt(random, 2 + size, 4 + size * 2)));
        list.add(new StructureCityPieces.PieceWeight(StructureCityPieces.House2.class, 15, MathHelper.getInt(random, 0, 1 + size)));
        list.add(new StructureCityPieces.PieceWeight(StructureCityPieces.House3.class, 8, MathHelper.getInt(random, 0 + size, 3 + size * 2)));
        Iterator<StructureCityPieces.PieceWeight> iterator = list.iterator();
    ...
    private static int updatePieceWeight(List<StructureCityPieces.PieceWeight> p_75079_0_)
    {
        boolean flag = false;
        int i = 0;

        for (StructureCityPieces.PieceWeight StructureCityPieces$pieceweight : p_75079_0_)
        {
            if (StructureCityPieces$pieceweight.villagePiecesLimit > 0 && StructureCityPieces$pieceweight.villagePiecesSpawned < StructureCityPieces$pieceweight.villagePiecesLimit)
            {
                flag = true;
            }

            i += StructureCityPieces$pieceweight.villagePieceWeight;
        }

        return flag ? i : -1;
    }

    private static StructureCityPieces.Village findAndCreateComponentFactory(StructureCityPieces.Start start, StructureCityPieces.PieceWeight weight, List<StructureComponent> structureComponents, Random rand, int structureMinX, int structureMinY, int structureMinZ, EnumFacing facing, int componentType)
    {
        Class <? extends StructureCityPieces.Village > oclass = weight.villagePieceClass;
        StructureCityPieces.Village StructureCityPieces$village = null;

        if (oclass == StructureCityPieces.House4Garden.class)
        {
            StructureCityPieces$village = StructureCityPieces.House4Garden.createPiece(start, structureComponents, rand, structureMinX, structureMinY, structureMinZ, facing, componentType);
        }
        else if (oclass == StructureCityPieces.Church.class)
        {
            StructureCityPieces$village = StructureCityPieces.Church.createPiece(start, structureComponents, rand, structureMinX, structureMinY, structureMinZ, facing, componentType);
        }
        else if (oclass == StructureCityPieces.House1.class)
        {
            StructureCityPieces$village = StructureCityPieces.House1.createPiece(start, structureComponents, rand, structureMinX, structureMinY, structureMinZ, facing, componentType);
        }
        else if (oclass == StructureCityPieces.WoodHut.class)
        {
            StructureCityPieces$village = StructureCityPieces.WoodHut.createPiece(start, structureComponents, rand, structureMinX, structureMinY, structureMinZ, facing, componentType);
        }
        else if (oclass == StructureCityPieces.Hall.class)
        {
            StructureCityPieces$village = StructureCityPieces.Hall.createPiece(start, structureComponents, rand, structureMinX, structureMinY, structureMinZ, facing, componentType);
        }
        else if (oclass == StructureCityPieces.Field1.class)
        {
            StructureCityPieces$village = StructureCityPieces.Field1.createPiece(start, structureComponents, rand, structureMinX, structureMinY, structureMinZ, facing, componentType);
        }
        else if (oclass == StructureCityPieces.Field2.class)
        {
            StructureCityPieces$village = StructureCityPieces.Field2.createPiece(start, structureComponents, rand, structureMinX, structureMinY, structureMinZ, facing, componentType);
        }
        else if (oclass == StructureCityPieces.House2.class)
        {
            StructureCityPieces$village = StructureCityPieces.House2.createPiece(start, structureComponents, rand, structureMinX, structureMinY, structureMinZ, facing, componentType);
        }
        else if (oclass == StructureCityPieces.House3.class)
        {
            StructureCityPieces$village = StructureCityPieces.House3.createPiece(start, structureComponents, rand, structureMinX, structureMinY, structureMinZ, facing, componentType);
        }

        return StructureCityPieces$village;
    }

    private static StructureCityPieces.Village generateComponent(StructureCityPieces.Start start, List<StructureComponent> structureComponents, Random rand, int structureMinX, int structureMinY, int structureMinZ, EnumFacing facing, int componentType)
    {
        ...
        else
        {
            ...
            while (j < 5)
            {
                ...
                for (StructureCityPieces.PieceWeight StructureCityPieces$pieceweight : start.structureVillageWeightedPieceList)
                {
                    k -= StructureCityPieces$pieceweight.villagePieceWeight;

                    if (k < 0)
                    {
                        if (!StructureCityPieces$pieceweight.canSpawnMoreVillagePiecesOfType(componentType) || StructureCityPieces$pieceweight == start.lastPlaced && start.structureVillageWeightedPieceList.size() > 1)
                        {
                            break;
                        }

                        StructureCityPieces.Village StructureCityPieces$village = findAndCreateComponentFactory(start, StructureCityPieces$pieceweight, structureComponents, rand, structureMinX, structureMinY, structureMinZ, facing, componentType);

                        if (StructureCityPieces$village != null)
                        {
                            ++StructureCityPieces$pieceweight.villagePiecesSpawned;
                            start.lastPlaced = StructureCityPieces$pieceweight;

                            if (!StructureCityPieces$pieceweight.canSpawnMoreVillagePieces())
                            {
                                start.structureVillageWeightedPieceList.remove(StructureCityPieces$pieceweight);
                            }
            ...
            StructureBoundingBox structureboundingbox = StructureCityPieces.Torch.findPieceBox(start, structureComponents, rand, structureMinX, structureMinY, structureMinZ, facing);

            if (structureboundingbox != null)
            {
                return new StructureCityPieces.Torch(start, componentType, rand, structureboundingbox, facing);
            }
            else
            {
                return null;
    ...
    private static StructureComponent generateAndAddComponent(StructureCityPieces.Start start, List<StructureComponent> structureComponents, Random rand, int structureMinX, int structureMinY, int structureMinZ, EnumFacing facing, int componentType)
    {
        if (componentType > 50)
        {
            return null;
    ...
    private static StructureComponent generateAndAddRoadPiece(StructureCityPieces.Start start, List<StructureComponent> p_176069_1_, Random rand, int p_176069_3_, int p_176069_4_, int p_176069_5_, EnumFacing facing, int p_176069_7_)
    {
        ...
        {
            StructureBoundingBox structureboundingbox = StructureCityPieces.Path.findPieceBox(start, p_176069_1_, rand, p_176069_3_, p_176069_4_, p_176069_5_, facing);

            if (structureboundingbox != null && structureboundingbox.minY > 10)
            {
                StructureComponent structurecomponent = new StructureCityPieces.Path(start, p_176069_7_, rand, structureboundingbox, facing);
    ...
    public static class Church extends StructureCityPieces.Village
        {
            public Church()
            {
            }

            public Church(StructureCityPieces.Start start, int type, Random rand, StructureBoundingBox p_i45564_4_, EnumFacing facing)
            {
                super(start, type);
            ...
            public static StructureCityPieces.Church createPiece(StructureCityPieces.Start start, List<StructureComponent> p_175854_1_, Random rand, int p_175854_3_, int p_175854_4_, int p_175854_5_, EnumFacing facing, int p_175854_7_)
            {
                ...
                return canVillageGoDeeper(structureboundingbox) && StructureComponent.findIntersecting(p_175854_1_, structureboundingbox) == null ? new StructureCityPieces.Church(start, p_175854_7_, rand, structureboundingbox, facing) : null;
            }
    ...
    public static class Field1 extends StructureCityPieces.Village
        {
            ...
            public Field1(StructureCityPieces.Start start, int type, Random rand, StructureBoundingBox p_i45570_4_, EnumFacing facing)
            {
                super(start, type);
                this.setCoordBaseMode(facing);
            ...
            public static StructureCityPieces.Field1 createPiece(StructureCityPieces.Start start, List<StructureComponent> p_175851_1_, Random rand, int p_175851_3_, int p_175851_4_, int p_175851_5_, EnumFacing facing, int p_175851_7_)
            {
                ...
                return canVillageGoDeeper(structureboundingbox) && StructureComponent.findIntersecting(p_175851_1_, structureboundingbox) == null ? new StructureCityPieces.Field1(start, p_175851_7_, rand, structureboundingbox, facing) : null;
            }
    ...
    public static class Field2 extends StructureCityPieces.Village
        {
            /** First crop type for this field. */
            private Block cropTypeA;
            /** Second crop type for this field. */
            ...
            public Field2(StructureCityPieces.Start start, int p_i45569_2_, Random rand, StructureBoundingBox p_i45569_4_, EnumFacing facing)
            {
            ...
            public static StructureCityPieces.Field2 createPiece(StructureCityPieces.Start start, List<StructureComponent> p_175852_1_, Random rand, int p_175852_3_, int p_175852_4_, int p_175852_5_, EnumFacing facing, int p_175852_7_)
            {
                ...
                return canVillageGoDeeper(structureboundingbox) && StructureComponent.findIntersecting(p_175852_1_, structureboundingbox) == null ? new StructureCityPieces.Field2(start, p_175852_7_, rand, structureboundingbox, facing) : null;
            }
    ...
    public static class Hall extends StructureCityPieces.Village
        {
            public Hall()
            {
            }

            public Hall(StructureCityPieces.Start start, int type, Random rand, StructureBoundingBox p_i45567_4_, EnumFacing facing)
            {
                super(start, type);
                this.setCoordBaseMode(facing);
            ...
            public static StructureCityPieces.Hall createPiece(StructureCityPieces.Start start, List<StructureComponent> p_175857_1_, Random rand, int p_175857_3_, int p_175857_4_, int p_175857_5_, EnumFacing facing, int p_175857_7_)
            {
                ...
                return canVillageGoDeeper(structureboundingbox) && StructureComponent.findIntersecting(p_175857_1_, structureboundingbox) == null ? new StructureCityPieces.Hall(start, p_175857_7_, rand, structureboundingbox, facing) : null;
            }
    ...
    public static class House1 extends StructureCityPieces.Village
        {
            public House1()
            {
            }

            public House1(StructureCityPieces.Start start, int type, Random rand, StructureBoundingBox p_i45571_4_, EnumFacing facing)
            {
                super(start, type);
                this.setCoordBaseMode(facing);
            ...
            public static StructureCityPieces.House1 createPiece(StructureCityPieces.Start start, List<StructureComponent> p_175850_1_, Random rand, int p_175850_3_, int p_175850_4_, int p_175850_5_, EnumFacing facing, int p_175850_7_)
            {
                ...
                return canVillageGoDeeper(structureboundingbox) && StructureComponent.findIntersecting(p_175850_1_, structureboundingbox) == null ? new StructureCityPieces.House1(start, p_175850_7_, rand, structureboundingbox, facing) : null;
            }
    ...
    public static class House2 extends StructureCityPieces.Village
        {
            ...
            public House2(StructureCityPieces.Start start, int type, Random rand, StructureBoundingBox p_i45563_4_, EnumFacing facing)
            {
                super(start, type);
                this.setCoordBaseMode(facing);
            ...
            public static StructureCityPieces.House2 createPiece(StructureCityPieces.Start start, List<StructureComponent> p_175855_1_, Random rand, int p_175855_3_, int p_175855_4_, int p_175855_5_, EnumFacing facing, int p_175855_7_)
            {
                ...
                return canVillageGoDeeper(structureboundingbox) && StructureComponent.findIntersecting(p_175855_1_, structureboundingbox) == null ? new StructureCityPieces.House2(start, p_175855_7_, rand, structureboundingbox, facing) : null;
            }
    ...
    public static class House3 extends StructureCityPieces.Village
        {
            public House3()
            {
            }

            public House3(StructureCityPieces.Start start, int type, Random rand, StructureBoundingBox p_i45561_4_, EnumFacing facing)
            {
                super(start, type);
                this.setCoordBaseMode(facing);
            ...
            public static StructureCityPieces.House3 createPiece(StructureCityPieces.Start start, List<StructureComponent> p_175849_1_, Random rand, int p_175849_3_, int p_175849_4_, int p_175849_5_, EnumFacing facing, int p_175849_7_)
            {
                ...
                return canVillageGoDeeper(structureboundingbox) && StructureComponent.findIntersecting(p_175849_1_, structureboundingbox) == null ? new StructureCityPieces.House3(start, p_175849_7_, rand, structureboundingbox, facing) : null;
            }
    ...
    public static class House4Garden extends StructureCityPieces.Village
        {
            ...
            public House4Garden(StructureCityPieces.Start start, int p_i45566_2_, Random rand, StructureBoundingBox p_i45566_4_, EnumFacing facing)
            {
            ...
            public static StructureCityPieces.House4Garden createPiece(StructureCityPieces.Start start, List<StructureComponent> p_175858_1_, Random rand, int p_175858_3_, int p_175858_4_, int p_175858_5_, EnumFacing facing, int p_175858_7_)
            {
                ...
                return StructureComponent.findIntersecting(p_175858_1_, structureboundingbox) != null ? null : new StructureCityPieces.House4Garden(start, p_175858_7_, rand, structureboundingbox, facing);
            }
    ...
    public static class Path extends StructureCityPieces.Road
        {
            private int length;
            ...
            public Path(StructureCityPieces.Start start, int p_i45562_2_, Random rand, StructureBoundingBox p_i45562_4_, EnumFacing facing)
            {
                super(start, p_i45562_2_);
                this.setCoordBaseMode(facing);
                this.boundingBox = p_i45562_4_;
                System.out.println(p_i45562_4_.toString());
            ...
            public void buildComponent(StructureComponent componentIn, List<StructureComponent> listIn, Random rand)
            {
                ...
                {
                    StructureComponent structurecomponent = this.getNextComponentNN((StructureCityPieces.Start)componentIn, listIn, rand, 0, i);
                ...
                {
                    StructureComponent structurecomponent1 = this.getNextComponentPP((StructureCityPieces.Start)componentIn, listIn, rand, 0, j);
                ...
                //Controls dimension offset? Seems useful for crossings
                if (flag && rand.nextInt(3) > 0 && enumfacing != null)
                {
                    switch (enumfacing)
                    {
                        case NORTH:
                        default:
                            StructureCityPieces.generateAndAddRoadPiece((StructureCityPieces.Start)componentIn, listIn, rand, this.boundingBox.minX - 1, this.boundingBox.minY, this.boundingBox.minZ - 3, EnumFacing.WEST, this.getComponentType());
                            break;
                        case SOUTH:
                            StructureCityPieces.generateAndAddRoadPiece((StructureCityPieces.Start)componentIn, listIn, rand, this.boundingBox.minX - 1, this.boundingBox.minY, this.boundingBox.maxZ - 0, EnumFacing.WEST, this.getComponentType());
                            break;
                        case WEST:
                            StructureCityPieces.generateAndAddRoadPiece((StructureCityPieces.Start)componentIn, listIn, rand, this.boundingBox.minX + 3, this.boundingBox.minY, this.boundingBox.minZ - 1, EnumFacing.NORTH, this.getComponentType());
                            break;
                        case EAST:
                            StructureCityPieces.generateAndAddRoadPiece((StructureCityPieces.Start)componentIn, listIn, rand, this.boundingBox.maxX - 5, this.boundingBox.minY, this.boundingBox.minZ - 1, EnumFacing.NORTH, this.getComponentType());
                    }
                }
                ...
                if (flag && rand.nextInt(3) > 0 && enumfacing != null)
                {
                    switch (enumfacing)
                    {
                        case NORTH:
                        default:
                            StructureCityPieces.generateAndAddRoadPiece((StructureCityPieces.Start)componentIn, listIn, rand, this.boundingBox.maxX + 1, this.boundingBox.minY, this.boundingBox.minZ - 3, EnumFacing.EAST, this.getComponentType());
                            break;
                        case SOUTH:
                            StructureCityPieces.generateAndAddRoadPiece((StructureCityPieces.Start)componentIn, listIn, rand, this.boundingBox.maxX + 1, this.boundingBox.minY, this.boundingBox.maxZ - 0, EnumFacing.EAST, this.getComponentType());
                            break;
                        case WEST:
                            StructureCityPieces.generateAndAddRoadPiece((StructureCityPieces.Start)componentIn, listIn, rand, this.boundingBox.minX + 3, this.boundingBox.minY, this.boundingBox.maxZ + 1, EnumFacing.SOUTH, this.getComponentType());
                            break;
                        case EAST:
                            StructureCityPieces.generateAndAddRoadPiece((StructureCityPieces.Start)componentIn, listIn, rand, this.boundingBox.maxX - 5, this.boundingBox.minY, this.boundingBox.maxZ + 1, EnumFacing.SOUTH, this.getComponentType());
                    }
                }
            }

            //Path width
            public static StructureBoundingBox findPieceBox(StructureCityPieces.Start start, List<StructureComponent> p_175848_1_, Random rand, int p_175848_3_, int p_175848_4_, int p_175848_5_, EnumFacing facing)
            {
                for (int i = 7 * MathHelper.getInt(rand, 9, 15); i >= 7; i -= 7)
                {
                    StructureBoundingBox structureboundingbox = StructureBoundingBox.getComponentToAddBoundingBox(p_175848_3_, p_175848_4_, p_175848_5_, 0, 0, 0, 7, 3, i, facing);
            ...
            public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn)
            {
                IBlockState iblockstate = this.getBiomeSpecificBlockState(ModBlocks.ASPHALT.getDefaultState());
                IBlockState iblockstate1 = this.getBiomeSpecificBlockState(ModBlocks.ASPHALT.getDefaultState());
                IBlockState iblockstate2 = this.getBiomeSpecificBlockState(ModBlocks.ASPHALT.getDefaultState());
                IBlockState iblockstate3 = this.getBiomeSpecificBlockState(ModBlocks.ASPHALT.getDefaultState());
    ...
    public static class PieceWeight
        {
            public Class <? extends StructureCityPieces.Village > villagePieceClass;
            public final int villagePieceWeight;
            public int villagePiecesSpawned;
            public int villagePiecesLimit;

            public PieceWeight(Class <? extends StructureCityPieces.Village > p_i2098_1_, int p_i2098_2_, int p_i2098_3_)
            {
    ...
    public abstract static class Road extends StructureCityPieces.Village
        {
            public Road()
            {
            }

            protected Road(StructureCityPieces.Start start, int type)
            {
                super(start, type);
            }
        }

    public static class Start extends StructureCityPieces.Well
        {
            public BiomeProvider biomeProvider;
            /** World terrain type, 0 for normal, 1 for flap map */
            public int terrainType;
            public StructureCityPieces.PieceWeight lastPlaced;
            /**
             ...
             */
            public List<StructureCityPieces.PieceWeight> structureVillageWeightedPieceList;
            ...
            public Start(BiomeProvider biomeProviderIn, int p_i2104_2_, Random rand, int p_i2104_4_, int p_i2104_5_, List<StructureCityPieces.PieceWeight> p_i2104_6_, int p_i2104_7_)
            {
                super((StructureCityPieces.Start)null, 0, rand, p_i2104_4_, p_i2104_5_);
    ...
    public static class Torch extends StructureCityPieces.Village
        {
            public Torch()
            {
            }

            public Torch(StructureCityPieces.Start start, int p_i45568_2_, Random rand, StructureBoundingBox p_i45568_4_, EnumFacing facing)
            {
            ...
            public static StructureBoundingBox findPieceBox(StructureCityPieces.Start start, List<StructureComponent> p_175856_1_, Random rand, int p_175856_3_, int p_175856_4_, int p_175856_5_, EnumFacing facing)
            {
    ...
    public abstract static class Village extends StructureComponent
        {
            ...
            protected StructureCityPieces.Start startPiece;

            public Village()
            {
            }

            protected Village(StructureCityPieces.Start start, int type)
            {
                super(type);
             ...
             */
            @Nullable
            protected StructureComponent getNextComponentNN(StructureCityPieces.Start start, List<StructureComponent> structureComponents, Random rand, int p_74891_4_, int p_74891_5_)
            {
                EnumFacing enumfacing = this.getCoordBaseMode();
                ...
                if (enumfacing != null)
                {
                    switch (enumfacing)
                    {
                        case NORTH:
                        default:
                            return StructureCityPieces.generateAndAddComponent(start, structureComponents, rand, this.boundingBox.minX - 1, this.boundingBox.minY + p_74891_4_, this.boundingBox.minZ + p_74891_5_, EnumFacing.WEST, this.getComponentType());
                        case SOUTH:
                            return StructureCityPieces.generateAndAddComponent(start, structureComponents, rand, this.boundingBox.minX - 1, this.boundingBox.minY + p_74891_4_, this.boundingBox.minZ + p_74891_5_, EnumFacing.WEST, this.getComponentType());
                        case WEST:
                            return StructureCityPieces.generateAndAddComponent(start, structureComponents, rand, this.boundingBox.minX + p_74891_5_, this.boundingBox.minY + p_74891_4_, this.boundingBox.minZ - 1, EnumFacing.NORTH, this.getComponentType());
                        case EAST:
                            return StructureCityPieces.generateAndAddComponent(start, structureComponents, rand, this.boundingBox.minX + p_74891_5_, this.boundingBox.minY + p_74891_4_, this.boundingBox.minZ - 1, EnumFacing.NORTH, this.getComponentType());
                    }
                }
             ...
             */
            @Nullable
            protected StructureComponent getNextComponentPP(StructureCityPieces.Start start, List<StructureComponent> structureComponents, Random rand, int p_74894_4_, int p_74894_5_)
            {
                EnumFacing enumfacing = this.getCoordBaseMode();
                ...
                if (enumfacing != null)
                {
                    switch (enumfacing)
                    {
                        case NORTH:
                        default:
                            return StructureCityPieces.generateAndAddComponent(start, structureComponents, rand, this.boundingBox.maxX + 1, this.boundingBox.minY + p_74894_4_, this.boundingBox.minZ + p_74894_5_, EnumFacing.EAST, this.getComponentType());
                        case SOUTH:
                            return StructureCityPieces.generateAndAddComponent(start, structureComponents, rand, this.boundingBox.maxX + 1, this.boundingBox.minY + p_74894_4_, this.boundingBox.minZ + p_74894_5_, EnumFacing.EAST, this.getComponentType());
                        case WEST:
                            return StructureCityPieces.generateAndAddComponent(start, structureComponents, rand, this.boundingBox.minX + p_74894_5_, this.boundingBox.minY + p_74894_4_, this.boundingBox.maxZ + 1, EnumFacing.SOUTH, this.getComponentType());
                        case EAST:
                            return StructureCityPieces.generateAndAddComponent(start, structureComponents, rand, this.boundingBox.minX + p_74894_5_, this.boundingBox.minY + p_74894_4_, this.boundingBox.maxZ + 1, EnumFacing.SOUTH, this.getComponentType());
                    }
                }
    ...
    public static class Well extends StructureCityPieces.Village
        {
            public Well()
            {
            }

            public Well(StructureCityPieces.Start start, int type, Random rand, int x, int z)
            {
                super(start, type);
             ...
             * Initiates construction of the Structure Component picked, at the current Location of StructGen
             */
            //Road offset from center
            public void buildComponent(StructureComponent componentIn, List<StructureComponent> listIn, Random rand)
            {
                StructureCityPieces.generateAndAddRoadPiece((StructureCityPieces.Start)componentIn, listIn, rand, this.boundingBox.minX - 0, this.boundingBox.maxY - 4, this.boundingBox.minZ + 1, EnumFacing.WEST, this.getComponentType());
                StructureCityPieces.generateAndAddRoadPiece((StructureCityPieces.Start)componentIn, listIn, rand, this.boundingBox.maxX + 0, this.boundingBox.maxY - 4, this.boundingBox.minZ + 1, EnumFacing.EAST, this.getComponentType());
                StructureCityPieces.generateAndAddRoadPiece((StructureCityPieces.Start)componentIn, listIn, rand, this.boundingBox.minX + 0, this.boundingBox.maxY - 4, this.boundingBox.minZ - 1, EnumFacing.NORTH, this.getComponentType());
                StructureCityPieces.generateAndAddRoadPiece((StructureCityPieces.Start)componentIn, listIn, rand, this.boundingBox.minX + 0, this.boundingBox.maxY - 4, this.boundingBox.maxZ + 1, EnumFacing.SOUTH, this.getComponentType());
            }
    ...
    public static class WoodHut extends StructureCityPieces.Village
        {
            ...
            public WoodHut(StructureCityPieces.Start start, int type, Random rand, StructureBoundingBox structurebb, EnumFacing facing)
            {
                super(start, type);
                this.setCoordBaseMode(facing);
            ...
            public static StructureCityPieces.WoodHut createPiece(StructureCityPieces.Start start, List<StructureComponent> p_175853_1_, Random rand, int p_175853_3_, int p_175853_4_, int p_175853_5_, EnumFacing facing, int p_175853_7_)
            {
                ...
                return canVillageGoDeeper(structureboundingbox) && StructureComponent.findIntersecting(p_175853_1_, structureboundingbox) == null ? new StructureCityPieces.WoodHut(start, p_175853_7_, rand, structureboundingbox, facing) : null;
            }
