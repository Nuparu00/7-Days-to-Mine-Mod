...
public class CityHelper {
	...
	public static void placeRandomCar(World world, BlockPos pos, EnumFacing facing, Random rand) {
		...
		if (te instanceof TileEntityCarMaster) {
			...
			master.setLootTable(ModLootTables.SEDAN, rand.nextLong());
	...
	public static void loadBuildings() {
		...
		buildings.add(new Building(new ResourceLocation(SevenDaysToMine.MODID, "apartment"), 40, -1,
				Blocks.STONE.getDefaultState().withProperty(BlockStone.VARIANT, BlockStone.EnumType.ANDESITE_SMOOTH)).setAllowedCityTypes(EnumCityType.CITY));
		...
		buildings.add(new BuildingFarm(new ResourceLocation(SevenDaysToMine.MODID, "farm"), 30,0, Blocks.STONE.getDefaultState()).setAllowedCityTypes(EnumCityType.TOWN, EnumCityType.VILLAGE));
