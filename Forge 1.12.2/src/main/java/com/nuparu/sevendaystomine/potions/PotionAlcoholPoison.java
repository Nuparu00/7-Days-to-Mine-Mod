...
public class PotionAlcoholPoison extends PotionBase {
	...
	public PotionAlcoholPoison(boolean badEffect, int color) {
		...
		this.registerPotionAttributeModifier(SharedMonsterAttributes.MOVEMENT_SPEED, "0d9a52e1-adc0-4c8b-bdad-3fe38a5d2657", -0.1D, 1);
        this.registerPotionAttributeModifier(SharedMonsterAttributes.MAX_HEALTH, "1acf3189-a3be-48d6-a8cb-9a3181c5ad36", -0.1D, 1);
