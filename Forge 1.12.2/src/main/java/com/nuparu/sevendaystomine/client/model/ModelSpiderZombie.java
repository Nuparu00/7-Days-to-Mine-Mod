...
public class ModelSpiderZombie extends ModelBase {
	...
	public ModelSpiderZombie(float modelSize) {
		...
		rightlegup.setTextureSize(128, 64);
		...
		leftlegup.setTextureSize(128, 64);
		...
		rightlegdown.setTextureSize(128, 64);
		...
		leftlegdown.setTextureSize(128, 64);
		...
		headwear.setTextureSize(128, 64);
